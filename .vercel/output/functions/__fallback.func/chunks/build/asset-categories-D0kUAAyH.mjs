...
import { defineComponent, ref, computed, watch, mergeProps, unref, isRef, withCtx, createVNode, createBlock, createCommentVNode, openBlock, createTextVNode, toDisplayString, Fragment, renderList, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full flex-1 min-h-0 flex flex-col" }, _attrs))} data-v-8c35793c>`);
      if (unref(isMounted)) {
        ssrRenderTeleport(_push, (_push2) => {
          _push2(`<div class="flex items-center gap-2 w-full justify-end" data-v-8c35793c><div class="relative max-w-[220px]" data-v-8c35793c>`);
          ...
          _push2(`</div><p class="text-xs text-muted-foreground tabular-nums hidden lg:block whitespace-nowrap" data-v-8c35793c>${ssrInterpolate(unref(filteredRows).length)} record${ssrInterpolate(unref(filteredRows).length !== 1 ? "s" : "")}</p>`);
          _push2(ssrRenderComponent(_component_Button, {
            ...
            default: withCtx((_, _push3, _parent2, _scopeId) => {
              if (_push3) {
                ...
                if (unref(syncing)) {
                  _push3(`<span class="ml-1 text-xs" data-v-8c35793c${_scopeId}>Syncing...</span>`);
                } else {
                  _push3(`<!---->`);
                }
              } else {
      ...
      _push(`<div class="shrink-0 border-b px-4 py-2 flex items-center gap-1.5 overflow-x-auto scrollbar-thin" data-v-8c35793c><!--[-->`);
      ssrRenderList(unref(tabs), (tab) => {
        _push(`<button class="${ssrRenderClass([unref(activeTab) === tab.key ? "bg-primary text-primary-foreground shadow-sm" : "text-muted-foreground hover:text-foreground hover:bg-muted", "px-3 py-1.5 rounded-lg text-xs font-medium whitespace-nowrap transition-all flex items-center gap-1.5"])}" data-v-8c35793c>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: tab.icon,
          class: "size-3.5"
        }, null, _parent));
        _push(` ${ssrInterpolate(tab.label)} <span class="${ssrRenderClass([unref(activeTab) === tab.key ? "bg-primary-foreground/20 text-primary-foreground" : "bg-muted text-foreground/60", "ml-0.5 text-[10px] tabular-nums px-1.5 py-0.5 rounded-full"])}" data-v-8c35793c>${ssrInterpolate(tab.count)}</span></button>`);
      });
      _push(`<!--]--></div>`);
      if (unref(loading)) {
        _push(`<div class="flex-1 flex items-center justify-center" data-v-8c35793c><div class="flex flex-col items-center gap-3 text-muted-foreground" data-v-8c35793c>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "i-lucide-loader-2",
          class: "size-8 animate-spin"
        }, null, _parent));
        _push(`<p class="text-sm" data-v-8c35793c>Loading asset categories...</p></div></div>`);
      } else {
        _push(`<div class="flex-1 min-h-0 overflow-auto" data-v-8c35793c>`);
                          ...
                          ssrRenderList(unref(currentColumns), (col) => {
                            _push4(ssrRenderComponent(_component_TableHead, {
                              ...
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(`<div class="flex items-center gap-1" data-v-8c35793c${_scopeId4}>${ssrInterpolate(col.label)} `);
                                  if (sortIcon(col.key)) {
              ...
              _push2(ssrRenderComponent(_component_TableBody, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                                ...
                                default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                  if (_push5) {
                                    if (col.key === "image_url") {
                                      _push5(`<div class="size-8 rounded-md overflow-hidden bg-muted flex items-center justify-center" data-v-8c35793c${_scopeId4}>`);
                                      if (imageUrl(row)) {
                                        _push5(`<img${ssrRenderAttr("src", imageUrl(row))}${ssrRenderAttr("alt", row.eng)} class="size-8 object-cover" loading="lazy" data-v-8c35793c${_scopeId4}>`);
                                      } else {
                                        _push5(ssrRenderComponent(_component_Icon, {
                                      ...
                                      _push5(`<div class="flex items-center gap-2" data-v-8c35793c${_scopeId4}><div class="size-7 rounded-lg bg-gradient-to-br from-amber-500/10 to-orange-500/10 flex items-center justify-center shrink-0" data-v-8c35793c${_scopeId4}>`);
                                      _push5(ssrRenderComponent(_component_Icon, {
                                        name: unref(activeTab) === "categories" ? "i-lucide-tag" : "i-lucide-tags",
                                        class: "size-3.5 text-amber-600 dark:text-amber-400"
                                      }, null, _parent5, _scopeId4));
                                      _push5(`</div><span class="font-medium" data-v-8c35793c${_scopeId4}>${ssrInterpolate(row.eng || "—")}</span></div>`);
                                    } else if (col.key === "arabic") {
                                      _push5(`<span dir="rtl" class="text-sm text-muted-foreground" data-v-8c35793c${_scopeId4}>${ssrInterpolate(row.arabic || "—")}</span>`);
                                    } else if (col.key === "A51_label") {
                                      _push5(`<!--[-->`);
                                      if (row.A51_label) {
                                        _push5(ssrRenderComponent(_component_Badge, {
                                          ...
                                          default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                            if (_push6) {
                                              _push6(`${ssrInterpolate(row.A51_label)}`);
                                            } else {
                                              return [
                                                createTextVNode(toDisplayString(row.A51_label), 1)
                                              ];
                                            }
                                          }),
                                          _: 2
                                        ...
                                        _push5(`<span class="text-muted-foreground/40" data-v-8c35793c${_scopeId4}>—</span>`);
                                      }
                                      _push5(`<!--]-->`);
                                    } else {
                                      _push5(`<span class="text-sm whitespace-nowrap" data-v-8c35793c${_scopeId4}>${ssrInterpolate(cellValue(row, col.key))}</span>`);
                                    }
                                  } else {
                                    return [
                                      col.key === "image_url" ? (openBlock(), createBlock("div", {
                                        ...
                                        createVNode("div", { class: "size-7 rounded-lg bg-gradient-to-br from-amber-500/10 to-orange-500/10 flex items-center justify-center shrink-0" }, [
                                          createVNode(_component_Icon, {
                                            name: unref(activeTab) === "categories" ? "i-lucide-tag" : "i-lucide-tags",
                                            class: "size-3.5 text-amber-600 dark:text-amber-400"
                                          }, null, 8, ["name"])
                                      ...
                                      }, toDisplayString(row.arabic || "—"), 1)) : col.key === "A51_label" ? (openBlock(), createBlock(Fragment, { key: 3 }, [
                                        row.A51_label ? (openBlock(), createBlock(_component_Badge, {
                                          key: 0,
                                          variant: "outline",
                                          class: "bg-amber-500/10 text-amber-600 border-amber-500/20 text-[10px]"
                                        }, {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(ssrRenderComponent(_component_TableCell, {
                              ...
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(`<div class="flex flex-col items-center gap-2 text-muted-foreground" data-v-8c35793c${_scopeId4}>`);
                                  _push5(ssrRenderComponent(_component_Icon, {
                                    name: "i-lucide-inbox",
                                    class: "size-8"
                                  }, null, _parent5, _scopeId4));
                                  _push5(`<p data-v-8c35793c${_scopeId4}>No asset categories found</p></div>`);
                                } else {
                                  return [
                                    createVNode("div", { class: "flex flex-col items-center gap-2 text-muted-foreground" }, [
                                      ...
                                      createVNode("p", null, "No asset categories found")
                                    ])
                                  ];
                                }
                              }),
                    ...
                    if (unref(hasMore)) {
                      _push3(`<tr data-v-8c35793c${_scopeId2}><td${ssrRenderAttr("colspan", unref(currentColumns).length)} class="h-10 text-center text-xs text-muted-foreground" data-v-8c35793c${_scopeId2}> Loading more… </td></tr>`);
                    } else {
                      _push3(`<!---->`);
                    }
                  } else {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/asset-categories.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const assetCategories = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8c35793c"]]);

export { assetCategories as default };
//# sourceMappingURL=asset-categories-D0kUAAyH.mjs.map
